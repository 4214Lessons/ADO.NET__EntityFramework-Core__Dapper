...
public partial class LibraryContext : DbContext
{
    ...
    public virtual DbSet<BooksViewTest> BooksViewTests { get; set; }
    ...
    string str = "Data Source=(localdb)\\ProjectModels;Initial Catalog=Library;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<BooksViewTest>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("BooksViewTest");
